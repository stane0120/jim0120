...
public class EmailDAO {
	...
	public List<EmailVO> Get(String loggedInUserId) {
		...
		StringBuilder sql = new StringBuilder();
		sql.append("select write_title, write_content");
		...
		try (Connection conn = new ConnectionFactory().getConnection();
			...
			while (rs.next()) {
				...
				EmailVO email = new EmailVO(write_title, write_content, write_date, user_id);
				list.add(email);
	...
	public List<EmailVO> Send(String loggedInUserId) {
	    ...
	    try (Connection conn = new ConnectionFactory().getConnection();
	        ...
	        while (rs.next()) {
	            ...
	            EmailVO emailVO = new EmailVO(write_title, write_content, write_date, user_id);
	            list.add(emailVO);         
	        } 
